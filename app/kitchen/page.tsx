...
export default function KitchenPage() {
  const kitchenProjects = getProjectsByCategory('kitchen');

  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <Breadcrumb items={[{ label: 'Kitchen' }]} />
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent flex items-end">
            <div className="p-8 text-white">
              ...
              <p className="text-xl text-gray-200 max-w-3xl animate-fade-in-delay">
                Transform your culinary space with our modern modular kitchens featuring 
                premium materials, innovative storage solutions, and sophisticated design.
              </p>
            </div>
          </div>
        </div>
      ...
      {kitchenProjects.length === 0 && (
        <div className="text-center py-12">
          ...
          <p className="text-gray-500 text-lg">No kitchen projects found.</p>
          <p className="text-gray-400 text-sm mt-2">Check back soon for new kitchen designs!</p>
        </div>
      )}
      ...
      <div className="mt-16 bg-gradient-to-r from-amber-50 to-orange-50 rounded-2xl p-8 text-center">
        ...
        <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
          Our kitchen specialists can design a functional and beautiful culinary space tailored to your needs.
        </p>
        <a
          href="/contact"
